(function () {
	...
	*/
	...
	serviceWorker.initialise({
	  ...
	  urlCacheSet: ['./index.html', './app.js?version=1.0.3.1644340075', './manifest.webmanifest', '/appcss/app.2021-12-16.css', // note no leading '.' - this is an absolute path
